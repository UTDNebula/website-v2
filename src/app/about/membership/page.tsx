    ...
    <>
      ...
      <div className="px-8 lg:px-16 xl:px-32 py-24 flex flex-col items-center gap-12">
        ...
        <p className="text-3xl">
          ...
          core values, we work to develop maintainable, high-quality tools that address gaps in
          campus resources and data accessibility in order to enhance the academic, social, and
          personal lives of students at UT Dallas. By joining Nebula Labs, students become part of a
          ...
          all members to actively participate and contribute. Above all, we cultivate an inclusive
          and supportive environment, valuing motivation and dedication over innate skill, and
          actively combat elitism to foster a culture where all members can thrive and contribute
          meaningfully. Joining Nebula Labs is not merely about membership; it&apos;s about becoming
          part of a community dedicated to making a tangible difference in the lives of students and
          beyond.
        </p>
      </div>
      <div className="px-8 lg:px-16 xl:px-32 py-24 flex flex-col items-center gap-12">
