...
const groupNameToDescMap = new Map<string, string>([
    ['Officers', `As a group of leaders, our officer team works together to guide 
    ...
    ['Division Heads', `By overseeing and managing specific areas within Nebula Labs, 
    ...
    ['Project Leads', `Playing a crucial role in shaping every project we work on, 
    ...
    ['Our Club Sponsor', `With more than a decade of teaching and mentoring experience 
