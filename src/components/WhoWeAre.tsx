  ...
  return (
    <div className="xl:pt-32 px-40 flex justify-between">
      <div className="w-[340px]">
        <h1 className="font-inter font-bold text-[80px] text-transparent bg-clip-text bg-gradient-to-br from-[#3634BB] via-[#573DFF] to-[#6166FA]">
          Who We Are
        </h1>
      </div>
      <div>
        ...
        <button className="mt-6 p-3 text-white bg-[#573DFF] rounded-full hover:bg-[#3634BB] transition-colors">
          Learn More
        </button>
      </div>
    </div>
